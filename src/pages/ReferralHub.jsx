  ...
  return (
    <div className="px-4 py-6 space-y-6 pb-24 max-w-2xl mx-auto">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Ganhe comissão por cada indicação convertida!</p>
      </div>
        ...
        <Card className="border-primary/20">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-xs">
              Compartilhe e ganhe comissões quando alguém contratar um plano
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2 pt-0">
            {!clientLink ? (
              <Button
                ...
                disabled={!user?.wallet_activation_paid}
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button
                    onClick={() => shareWhatsApp(clientLink, '🎉 Use meu link do Clube Sou Brasil para se cadastrar!')}
      ...
      {/* Modal de pagamento de ativação */}
      {showPaymentModal && (
